  ...
  return (
    <Container>
      ...
      <Main>
        ...
        rating={3.5}
        title={"Flower Pot"}/>
        <Card  id={4} image={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyN_IsKhndYR6wJz4LVGPYk2eKjJv6SlwNJQ&usqp=CAU"}
        price={29999}
        rating={4}
        title={"Laptop (Dell)"}/>
        ...
        rating={3}
        title={"Echo Dot"}/>
        <Card  id={6} image={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyN_IsKhndYR6wJz4LVGPYk2eKjJv6SlwNJQ&usqp=CAU"}
        price={25000}
        rating={3}
        title={"Echo Dot"}/>
        ...
        rating={5}
        title={"Earpads"}/>
        <Card  id={8} image={"https://m.media-amazon.com/images/I/8179uEK+gcL._AC_UF1000,1000_QL80_.jpg"}
        price={550}
        rating={4.5}
        title={"Harry Potter Collections"}/>
      </Main>
    </Container>
  )
}
